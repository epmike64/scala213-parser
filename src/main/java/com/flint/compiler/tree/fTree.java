...
public interface fTree {
	...
	enum fTreeNKind {
		N_ROOT, N_ID_OPERATOR, N_IF_KW_LEAF, N_CASE_KW_LEAF, N_GUARD_LEAF, N_PROD_ROOT_LEAF, N_ELSE_KW_LEAF,  N_ID_LEAF, N_FUN_CALL_LEAF, N_CASE_LEAF,  N_TYPE_LEAF,N_COMMA, N_FAT_ARROW, N_LPAREN, N_LCURL /*N_RPAREN*/
	}
	/**
